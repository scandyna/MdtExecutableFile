...
```
cd existing_repo
git remote add origin https://gitlab.com/scandyna/mdtexecutablefile.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/scandyna/mdtexecutablefile/-/settings/integrations)
